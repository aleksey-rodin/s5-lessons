        ...
        with self._db.client().cursor(row_factory=class_row(OrderObj)) as cur:
            cur.execute(
                """
                    ...
                    join dds.dm_restaurants dr on dr.restaurant_id = (o.object_value::json->>'restaurant')::json->>'id'
                    join dds.dm_users du on du.user_id = (o.object_value::json->>'user')::json->>'id'
                    join dds.dm_timestamps dt on dt.ts = (o.object_value::json->>'date')::timestamp

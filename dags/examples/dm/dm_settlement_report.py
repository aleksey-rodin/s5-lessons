...
from examples.dm import EtlSetting, CDMEtlSettingsRepository
...
class SettlementsDDS:
    ...
    def list_settlements(self, rank_threshold: datetime, limit: int) -> List[SettlementObj]:
...
class SettlementLoader:
    WF_KEY = "cdm.dm_settlement_report_workflow"
    ...
    def load_settlements(self):
        ...
        with self.pg_dest.connection() as conn:
            ...
            load_queue = self.origin.list_settlements(last_loaded, self.BATCH_LIMIT)
